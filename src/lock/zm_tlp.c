...
#define zm_tlp_init_high_p(L) zm_mmcs_init(&L->high_p)
...
#elif (ZM_TLP_HIGH_P == ZM_MCS)
#define zm_tlp_release_high_p(L) zm_mmcs_release(&L->high_p);
#elif (ZM_TLP_HIGH_P == ZM_HMCS)
...
#define zm_tlp_init_low_p(L) zm_mmcs_init(&L->low_p)
...
#elif (ZM_TLP_LOW_P == ZM_MCS)
#define zm_tlp_release_low_p(L) zm_mmcs_release(&L->low_p);
#elif (ZM_TLP_LOW_P == ZM_HMCS)
...
#elif (ZM_TLP_HIGH_P == ZM_MCS)
#define zm_tlp_nowaiters_high_p(L) zm_mmcs_nowaiters(&L->high_p)
#elif (ZM_TLP_HIGH_P == ZM_HMCS)
